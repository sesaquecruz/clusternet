...
from remotenet.apis.models.helpers import get_ipv4_address
from remotenet.apis.models.tunnel import TunnelModel
...
class WorkerModel:
    ...
    def __init__(self, id: int, name: str, controller_ip: str, controller_port: int, 
...
class AddWorkerModel:
    ...
    def __init__(self, name: str, controller_ip: str, controller_port: int, 
        url: str, is_running: bool = False) -> None:
        self.set_name(name)
        self.set_ip(controller_ip)
        self.set_port(controller_port)
        self.set_url(url)
    ...
    def set_url(self, url: str):
        if(url == ''): raise Exception('Param url must be non empty')
        self.url = url
